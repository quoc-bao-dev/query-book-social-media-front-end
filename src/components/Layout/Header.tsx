                ...
                <div className="w-full mx-auto px-4 flex justify-between items-center relative">
                    ...
                    <div className="flex gap-6 items-center">
                        ...
                        <div className="relative">
                            <input
                                type="text"
                                className="bg-input pr-6 pl-12 py-1 border-none outline-none ring-blue-500 rounded-md"
                                placeholder="Search..."
                            />
                    ...
                    {/* Nav */}
                    <div className="absolute left-[50%] translate-x-[-50%] flex gap-20">
                        <div className="">
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                fill="none"
                                ...
                                strokeWidth={1.5}
                                stroke="currentColor"
                                className="size-8 font-bold  text-primary-500 stroke-[1.75] "
                            >
                                <path
                                    strokeLinecap="round"
                                    strokeLinejoin="round"
