      ...
      <div className="flex justify-center">
        <div className="w-[1028px]">
          ...
          <div className="flex justify-between">
            ...
            <div className="w-80 flex-col">
              <div className="mt-4 h-24 rounded-[16px] overflow-hidden relative border-b border flex justify-around items-center px-6 bg-card">
                <div className="text-center">
                  ...
                  <span className="text-sm text-neutral-800">Follower</span>
                </div>
                ...
                <div className="text-center">
                  ...
                  <span className="text-sm text-neutral-800">Following</span>
                </div>
              </div>
              <div className="rounded-[16px] overflow-hidden relative border-b border mt-4 h-80 bg-card">
                ...
                <span className="text-sm text-neutral-800 pl-6 block mt-4">
                  I'm a front-end developer at FPT Software, I have 3 years of
                  experience in development application
                </span>
                ...
                <div className="flex items-center mt-4 pl-6 space-x-2.5">
                  ...
                  <span className="text-sm text-neutral-800">0919 616 224</span>
                </div>
                <div className="flex items-center mt-4 pl-6 space-x-2.5">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                  ...
                  <span className="text-sm text-neutral-800">jaydon.dev</span>
                </div>
              </div>
            ...
            {/* posts */}
            <div className="mt-4 w-[680px] h-[400px] flex flex-col border border-b rounded-2xl p-4 bg-card"></div>
