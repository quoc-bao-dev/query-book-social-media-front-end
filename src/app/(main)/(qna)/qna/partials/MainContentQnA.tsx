...
const MainContentQnA = () => {
  ...
  return (
    <div className="bg-card max-h-full p-6 ">
      ...
      {filteredQuestions.length > 0 ? (
        filteredQuestions.map((q) => (
          <div
            key={q.id}
            className="border-b py-4 flex items-center rounded-lg shadow-md mb-4"
          >
            ...
            <div className="flex-1 flex flex-col">
              <Link
                href="/detail-qna"
                className="text-xl font-semibold text-gray-800 cursor-pointer hover:text-green-600 overflow-hidden"
