      ...
      <div className='w-[1200px] mx-auto'>
        ...
        <div className='grid grid-cols-3 gap-5 mt-16'>
          ...
          <div className='w-full h-full p-6 border border-neutral-200 rounded-lg'>
            <h2 className='font-semibold text-2xl text-neutral-900'>Medium</h2>
            <p className='mt-5 text-sm text-neutral-300'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Odio,
              illum nihil fuga qui pariatur voluptatem illo, ad neque ipsum
              ratione laudantium dolore voluptatum labore iste odit
            </p>
